						...
						start={
							<div className="my-2">
								...
								<Dropdown
									...
									placeholder={clientesQuery.isLoading ? "Cargando..." : "Seleccione un cliente"}
									required
									filter
									showClear
									showFilterClear
					...
					<DataTable
						...
						header={
							<div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
								<h5 className="m-0">{selectedCliente?.razonSocial ? `Facturas de ${selectedCliente.razonSocial}` : 'Seleccione un cliente'}</h5>
						...
						emptyMessage={!selectedCliente ? "Seleccione un cliente" : "No se encontraron facturas"}
					>
